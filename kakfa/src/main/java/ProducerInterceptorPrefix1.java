...
public class ProducerInterceptorPrefix1 implements ProducerInterceptor<String, String> {
    ...
    @Override
    public void close() {
        System.out.println("interceptor1 send success:" + sendSuccess + ", send failure:" + sendFailure);
    }
